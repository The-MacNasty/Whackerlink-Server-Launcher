...
IDEOLOGY:
          ...
          Powershell widnow within file explorer and type ir coy and paste a command line each time i needed to start the WL server. This wasnt very oftem but there was time like when my
